...
// const ORDERID = extractionStrConfig.BYDXIAN.ORDERID;
const ORDERDATE = extractionStrConfig.BYDXIAN.ORDERDATE;
const MATERIALNO = extractionStrConfig.BYDXIAN.MATERIALNO;
const COUNT = extractionStrConfig.BYDXIAN.COUNT;
// const TYPE = extractionStrConfig.BYDXIAN.TYPE;
// const CLOSEDSTATUS = extractionStrConfig.BYDXIAN.CLOSEDSTATUS;
// const FINISHSTATUS = extractionStrConfig.BYDXIAN.FINISHSTATUS;
// const DELIVERYDATE = extractionStrConfig.BYDXIAN.DELIVERYDATE;
// const NAME = extractionStrConfig.BYDXIAN.NAME;
...
export default async function BYDXIANXLSX(file) {
...
function formatData(result) {
  ...
  let orderId = "BYD-Xian" + moment().format("YYYYMMDDHHmmss");
  let orderDate;
