...
const MATERIALNO = extractionStrConfig.SANYKUNSHAN.MATERIALNO;
...
export default async function SANYKUNSHANXLSX(file) {
...
function formatData(result) {
  ...
  let orderId = "Sany-Kunshan" + moment().format("YYYYMMDDHHmmss");
